...
1. ТерФункция   - Функция `Применить` с тремя параметром
1. УниПроцедура - Процедура `Принять` с одним параметром
1. УниПроцедура - Процедура `Принять` с двумя параметрами
1. УниПроцедура - Процедура `Принять` с тремя параметрами
